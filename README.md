...
Built as a set of independently scalable services: a web dashboard for admins and lecturers, 
edge agents running on classroom devices, an ML-powered recognition service, and an attendance 
service that owns the system of record.
